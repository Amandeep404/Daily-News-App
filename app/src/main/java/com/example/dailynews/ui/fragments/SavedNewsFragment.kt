...
class SavedNewsFragment : Fragment(R.layout.fragment_saved_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getSaveNews().observe(viewLifecycleOwner, Observer { articles ->// whenever our data in the database changes then
        // this observer is called and passes us the new list of articles
